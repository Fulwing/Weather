...
- [Environment Setup](#environment-setup)
  ...
  - [RaspberryPi Environment](#raspberrypi-environment)
    - [Step 1: Set up your Raspberry Pi](#step-1-set-up-your-raspberry-pi)
    - [Step 2: Install Python](#step-2-install-python)
    - [Step 3: Get Adafruit Python DHT Sensor Library](#step-3-get-adafruit-python-dht-sensor-library)
    - [Step 4: Install AWS IoT Device SDK for Python](#step-4-install-aws-iot-device-sdk-for-python)
    - [Step 5: Clone the Git repository](#step-5-clone-the-git-repository)
...
4. Create a target group with the appropriate settings, Protocol - HTTP, Port - 8080, if you change your Tomcat port change the port here too, and choose the same VPC as the load balancer.
